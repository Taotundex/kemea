...
function InfosSurLentreprise() {
  return (
    <div className='affordabilitycalculator'>
      <div className="container">
        <div className="py-3">
          <span>Kemea</span> <RiArrowRightSLine className='fs-4' /> <span className='text-primary'>Infos sur l’entreprise</span>
        </div>
...
export default InfosSurLentreprise