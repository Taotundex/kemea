...
function Profile() {
  ...
  return (
    <div style={{overflowX: 'hidden',marginTop: '70px'}}>
        <div className="hero">
            <img src={profileImg} width='100%' alt="" />
            <Link to='' className='text-decoration-none mod1'>Modify the picture</Link>
        </div>
        <div className="container">
            <div className="office px-4 mb-5">
                <div className="row g-lg-5 g-md-4 g-3 d-flex align-items-center w-100">
                    <div className="col col-lg-2 col-md-3 col-4">
                        <div className="img">
                            <img src={RemaxSm} width='100%' alt="" />
                            <div className="mod">
                                <Link to='' className='text-decoration-none mod2'>Modify</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col col-lg-7 col-md-5 col-8">
                        <div className="prop">
                            <h3>RE/MAX Ra’annna</h3>
                            <p>152 Properties  <span>· Member since 2023</span></p>
                            <div className="d-flex gap-2 text-primary loc" style={{fontSize: '12px !important'}}>
                                <MdLocationOn className='fs-4' /> Ahuza St 70, Ra'anana
                                <Link to='' style={{marginLeft: '20px', fontWeight: '600'}}>Modify</Link>
                            </div>
                        </div>
                    </div>
