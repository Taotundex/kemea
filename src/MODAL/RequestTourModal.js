...
const ReqestTourModal = ({ show, handleClose }) => {
  ...
  return (
    <div className="request-tour d-flex align-items-center justify-content-center">
      <Modal show={show} size='md' onHide={handleClose} centered style={{width: '375px !important'}}>
        ...
        <Modal.Body>
          {step === 1 && (
            <div className="step-content">
              ...
              <Row className="mb-3">
                <Col>
                  <Button className="w-100 date-button py-5">WED Apr 10</Button>
                </Col>
                <Col>
                  <Button className="w-100 date-button py-5">THU Apr 11</Button>
                </Col>
                <Col>
                  <Button className="w-100 date-button py-5">FRI Apr 12</Button>
                </Col>
              </Row>
