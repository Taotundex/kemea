...
import RentoutImg from '../images/rent-out-img.png';
                    ...
                    <SwiperSlide>
                        <div className="row align-items-center g-5">
                            <div className="col col-lg-7 col-md-6 col-12">
                                <div className="text">
                                    <h1>Are you owners and want to rent your home?</h1>
                            ...
                            <div className="col col-lg-5 col-md-6 col-12">
                                <div className="img">
                                    <img src={RentoutImg} width='100%' alt="" />
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
                                    ...
                                    <form action="">
                                        <div className="row gx-5">
                                            ...
                                            <div className="col col-12">
                                                <div className="input number">
                                                    <label htmlFor="What is the desired rent?*">What is the desired rent?*</label>
                                                    <div className="d-flex">
